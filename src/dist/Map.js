...
var Map = function () {
  ...
  if (error) return react_1["default"].createElement("div", null, error);
  return react_1["default"].createElement(
    react_leaflet_1.MapContainer,
    { center: [0, 0], zoom: 2, style: { height: "100vh", width: "100%" } },
    ...
    images.map(function (image) {
      ...
      var customIcon = leaflet_1["default"].icon({
        iconUrl: "https://wanderingmixedtape-admin.lohner.cloud" + image.image.formats.small.url,
        iconSize: [32, 32],
        iconAnchor: [16, 32],
        popupAnchor: [0, -32],
      });
      return react_1["default"].createElement(
        ...
        react_1["default"].createElement(
          ...
          ((_a = image.image) === null || _a === void 0
            ? void 0
            : _a.formats) &&
            react_1["default"].createElement("img", {
              src: "https://wanderingmixedtape-admin.lohner.cloud" + image.image.formats.large.url,
              alt: image.locationName,
              style: { maxWidth: "200px" },
            }),
          image.description.map(function (para, index) {
            return react_1["default"].createElement(
              "p",
              { key: index },
              para.children.map(function (child, childIndex) {
                return react_1["default"].createElement(
                  "span",
                  {
                    key: childIndex,
